...
class AlienInvasion:
    ...
    def _check_events(self):
        """Responf to keyboard and mouse events"""
    ...
    def _update_screen(self):
        """Update images on the screen, and flip a new screen"""
    ...
    def _create_fleet(self):
        ...
        # Spacing between each alien is equal to one alien alien width
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        available_space_x = self.settings.screen_width - (2 * alien_width)
        number_aliens_x = available_space_x // (2*alien_width)

        #Determine thew number of rows of aliens that fit on the screen
